...
let myStrongest = monstersInYourPocket.filter((element) => {
  return element.CP > 200 ? element : delete element
})
...
let bobsTotal = purchases.reduce((runningTotal, curElement, curIndex, wholeArray) => {
  if (curElement.owner === "Bob") {
    return curElement.price + runningTotal
